...
hello("홍길동", "반갑습니다");
hello("영심이"); //message = "안녕하세요" 지정 안하는 경우, undefined
...
// 서로 다른 2개의 배열을 합치고자 할 때 : concat / 전개연산자
...
const fruits02 = fruits01; //원본데이터 변경 => 사본데이터 변경
...
// const fruits03 = [...fruits01]; //원본데이터 변경 => 사본데이터 변경x
// fruits01[0] = "grape";
// console.log(fruits01);
// console.log(fruits03);

//객체안에 신규 key & value를 생성하는 방법 : 온점표기법/대괄호표기법
// const book = {
//   title: "자바스크립트",
//   pages: 500,
// };

// book.publishde = "2024-03";
// console.log(book);

// book["author"] = "david"; //대괄호 안에는 문자열 작성하기
// console.log(book);
...
// const obj = {
//   [fn()]: "함수 키",
//   [`${add(10, 20)} key`]: "계산식 키", //문자열로 변환
// };

// console.log(obj);

//symbol( ) : 유일무이한 값을 생성 , 외부에서 특정 객체의 키값을 찾아오지 못하도록 하기 위한 목적
