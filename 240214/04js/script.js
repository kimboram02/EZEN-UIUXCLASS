...
//1. 사용자에게 키값 가져오기
//2. 사용자에게 몸무게값을 가져오기
//3. 사용자에게 받아온 키 & 몸무게값을 가지고 적정체중 구하기
...
// result = result
//   ? "적정체중이시네요! 축하드립니다."
//   : "적정체중이 아닙니다. 노력해주세요!"; //값재할당 let
// document.write(`${userName}님 ${result}`);

//사용자로부터 교통비와 식비, 음료비를 받아서 계산한 후 해당 값이 1만원을 초과한 경우에는 "00원 초과하였습니다. 조금만 더 노력해주세요" 라고 웹브라우저 화면에 출력해주시고, 만약 1만원을 초과하지 않은 경우에는 "00원 남았습니다. 돈관리 잘하셨습니다"라고 웹브라우저 화면에 출력해주세요
// 1. 교통비, 식비, 음료비를 받는다
// 2. 사용자로부터 받은 3개의 값을 계산한다
// 3. 계산된 값이 1만원 미만인지 여부를 확인한다
// 4. 결산된 값의 결과값에 따라서 "A"메세지를 출력할지, "B"메세지를 출력할지 결정한다
