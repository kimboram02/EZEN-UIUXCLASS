...
// 배열.forEach(function(배열안에 있는 각각의 아이템을 하나씩 찾아옴 : 변수이름){
//   실행문
// })
...
//do while = while 실무에서 동일 / do while 실무에서 잘 사용x/0을 입력해도 * 나옴
// do {
//   document.write("*");
//   stars--;
// } while (stars > 0);
...
//사용자에게 숫자를 하나 전달받으세요
//해당 숫자가 소수인지 아닌지 식별한 후 만약 해당 숫자가 소수라면 웹브라우저 화면에 "00 숫자는 소수입니다" 라고 출력해주세요
...
//웹브라우저 화면에 아래 보이는 배열 아이템 중 10이상되는 숫자만 출력해주세요
...
let sum = 0; //숫자가 될 수 있게금 0이라는 임의의 숫자를 넣음 => 0을 안 넣으면 NaN
...
// console.log(sum +1); //NaN : undefined 정의되지 않은 값에 숫자를 더하니 NaN  => 0을 할당하므로써 숫자
